#include "../patterns.h"                                                
PATTERN( IP_Trim_Read_Vref, logic ) 
@{//mg
...
% VEC             10X10L,TS1,EBM_ENABLE				  //Dout0   vref trim0-----vref_trim_rd::
% VEC             10X10L,TS1,EBM_ENABLE,EBM_INC		  //Dout1   vref trim1
% VEC             10X10L,TS1,EBM_ENABLE,EBM_INC		  //Dout2   vref trim2
% VEC             10X10H,TS1,EBM_ENABLE,EBM_INC		  //Dout3   vref trim3
% VEC             10X10L,TS1		  //Dout4   Temp0     
% VEC             10X10L,TS1		  //Dout5   Temp1     
% VEC             10X10L,TS1		  //Dout6   Temp2     
% VEC             10X10H,TS1		  //Dout7   Temp3     
% RPT 9           10X10X,TS1
% VEC	          10X10X,TS1
VAR DONE