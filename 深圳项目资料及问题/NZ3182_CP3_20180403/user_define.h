...
#define stb_cal_address(addr1, state)				\
...
%   pinfunc		tset1, PS_DEF						\n	\
	chips		state								\n	\
	datgen      sdbase2, sdmain2, dmain2,SUBTRACT	\n	
...
stb_send_data(labelname,stb_active_stateX32)				\n	\
cycle_delay(labelname##_dummy,0x1000,stb_active_stateX32)	\n	

#define serial_test_mode_entryX128(labelname)					\
stb_set_data(0x2015, 0x0302,dummy_stateX128)				\n	\
stb_send_data(labelname,stb_active_stateX128)				\n	\
cycle_delay(labelname##_dummy,0x1000,stb_active_stateX128)	\n	
/***************************************************
